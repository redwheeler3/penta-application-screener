...
everywhere it matters — application intake, the access allowlist, the User record,
...
def normalize_email(value: Any) -> str:
    ...
    value (stored values may be None or non-string) and coerces to str first, so
